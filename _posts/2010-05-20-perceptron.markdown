...
![Alt text](/assets/perceptron_OR_AND.jpg)  
<small>Tables for OR and AND gates</small>
...
<object width="500" height="200" data="/assets/perceptron.swf"></object>  
<small>Perceptron</small>
...
[download source files](/assets/perceptron_source.zip)